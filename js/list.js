...
//拉钩效果
  var oUl = document.getElementById("list_ul1");
  ...
  function getDirection(obj,oEvent){ 
    ...
    var y = getPos(obj).top + obj.offsetHeight/2 - oEvent.clientY;
     return  Math.round((Math.atan2(y,x)*180/Math.PI + 180)/90)%4; //弧度--角度--+180--/90--四舍五入
  ...
  function lagou(obj){
    obj.onmouseover = function(ev){
      ...
      move(oSpan,{left:0,top:0},{duration:400,easing:Tween.Linear});
    };
    ...
    obj.onmouseout = function(ev){
      ...
      switch(n){
        case 0:
          move(oSpan,{left:-160,top:0},{duration:400,easing:Tween.Linear});
          break;
        case 1:
          move(oSpan,{left:0,top:160},{duration:400,easing:Tween.Linear}); 
          break;
        case 2:
           move(oSpan,{left:160,top:0},{duration:400,easing:Tween.Linear});
          break;
...
// 划入小图banner
var oCon = document.getElementById('list_ul1');
var aWork_conLi = oCon.children;

var oBg = document.getElementById('heian');
var oDatu = document.getElementsByClassName('work_datu'); 
var aCha = document.getElementsByClassName('close');
...
for(var i=0;i<aCha.length;i++){
   ...
   aCha[i].style.backgroundColor  = 'rgb('+r+','+g+','+b+')';
}
